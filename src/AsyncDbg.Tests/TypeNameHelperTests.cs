...
namespace Test.AsyncCausalityInspector
{
    ...
    public class TypeNameHelperTests
    {
        ...
        [TestCase("ManualResetEventSlimOnTheStack.Program+<>c+<<RunAsync>b__1_0>d", "ManualResetEventSlimOnTheStack.Program.RunAsync.lambda0")]
        [TestCase("ManualResetEventSlimOnTheStack.Program+<>c+<<RunAsync>b__1_1>d", "ManualResetEventSlimOnTheStack.Program.RunAsync.lambda1")]
