...
//using ClrFieldValue = AsyncInspector.Core.ClrFieldValue;
//using ClrInstance = AsyncInspector.Core.ClrInstance;

//namespace NugetReferenceProject.Extensions
//{
//    internal class ClrInstanceDynamicProxy2 : DynamicObject
//    {
//        private readonly ClrInstance _instance;

//        /// <nodoc />
//        public ClrInstanceDynamicProxy2(AsyncInspector.Core.ClrInstance clrInstance)
//        {
...
//        {
//            return _instance.TryGetMember(binder.Name, out result);
//        }
...
//            {
//                var length = Type.GetArrayLength(_instance.ObjectAddress);
...
//            for (int i = 0; i < length; i++)
//            {
//                var elementAddress = Type.GetArrayElementAddress(_instance.ObjectAddress, i);
